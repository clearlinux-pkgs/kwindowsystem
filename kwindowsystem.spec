...
Source0  : https://download.kde.org/stable/frameworks/5.104/kwindowsystem-5.104.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.104/kwindowsystem-5.104.0.tar.xz.sig
...
%prep
%setup -q -n kwindowsystem-5.104.0
cd %{_builddir}/kwindowsystem-5.104.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679520779
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5WindowSystem.so.5.104.0
