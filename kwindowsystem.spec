...
Version  : 5.107.0
Release  : 68
URL      : https://download.kde.org/stable/frameworks/5.107/kwindowsystem-5.107.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.107/kwindowsystem-5.107.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.107/kwindowsystem-5.107.0.tar.xz.sig
...
%prep
%setup -q -n kwindowsystem-5.107.0
cd %{_builddir}/kwindowsystem-5.107.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686532839
mkdir -p clr-build
pushd clr-build
