...
Source0  : https://download.kde.org/stable/frameworks/5.93/kwindowsystem-5.93.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.93/kwindowsystem-5.93.0.tar.xz.sig
...
%prep
%setup -q -n kwindowsystem-5.93.0
cd %{_builddir}/kwindowsystem-5.93.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649699884
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kwindowsystem-5.93.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kwindowsystem/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/kwindowsystem-5.93.0/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/kwindowsystem/3c3d7573e137d48253731c975ecf90d74cfa9efe
cp %{_builddir}/kwindowsystem-5.93.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/kwindowsystem/6f1f675aa5f6a2bbaa573b8343044b166be28399
cp %{_builddir}/kwindowsystem-5.93.0/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kwindowsystem/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/kwindowsystem-5.93.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kwindowsystem/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/kwindowsystem-5.93.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kwindowsystem/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/kwindowsystem-5.93.0/LICENSES/MIT.txt %{buildroot}/usr/share/package-licenses/kwindowsystem/a0193e3fccf86c17dc71e3f6c0ac0b535e06bea3
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5WindowSystem.so.5.93.0
